...
class atmocnlndice5(optimize_model.OptimizeModel):
    ...
    def optimize(self):
        ...
        X_range = ['x[0] + x[1] + x[3]', 'x[0] + x[1] + x[2]']
        if len(X_range) > 1 :
            max_x = 'max(' + ','.join(X_range) + ')'
        else:
            max_x = X_range[0]
...
class atmocnlndice17(optimize_model.OptimizeModel):
    ...
    def optimize(self):
        ...
        X_range = ['x[2] + x[3] + x[1]', 'x[2] + x[3] + x[0]']
        if len(X_range) > 1 :
            max_x = 'max(' + ','.join(X_range) + ')'
        else:
            max_x = X_range[0]
