...
def run_train(epochs, model, optimizer, scheduler, ntrain, ntest, s):
    ...
    in_x = np.double([1024, 768, 8, 16, 24, 32, 48,  64, 96, 128, 192, 256, 384, 512, 768, 1024])
    in_y = np.double([20343976669, 21748941348, 648053816836, 407723774319, 287959373101, 207071072463, 153187178741, 121094583791, 96994835398, 
                        68705395470, 51546717288, 44440623593,  32004804913, 41238061828,  21748941348, 20343976669])
