...
{
    system("rm -f ./out/func.out");
    system("sh func_trace.sh ../../bin/GOMO ./out/0_time.out ./out/func.out");
	ifstream fr2;
	fr2.open("./out/func.out");
    ...
    fw<<"all time: "<< outtime << " "<<1.0*outtime/1000000<<" ms"<<endl;
